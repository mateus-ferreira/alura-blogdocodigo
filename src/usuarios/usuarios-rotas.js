...
module.exports = app => {
  ...
  app
    ...
    .get([middlewaresAutenticacao.bearer, autorizacao], usuariosControlador.lista('usuario', 'ler'))

  app
    .route('/usuario/:id')
    .delete(
      [middlewaresAutenticacao.bearer, middlewaresAutenticacao.local, autorizacao('usuario', 'remover')], usuariosControlador.deleta)
}
